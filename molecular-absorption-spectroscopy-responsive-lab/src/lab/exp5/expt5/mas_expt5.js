    ...
    function initial_function(){
        ...
        document.getElementById("demo").innerHTML = "Step-No 1: Prepare an 1 x 10^-3 M 2-nitroaniline solution. Weigh out 0.0138 g of material and disslove in 100ml of water. This is used as stock solution. Trn on the instument clicking in the power button and wait for 30 min for the initialisation of the instrument.";
    ...
    function scan(){
        if(step_no==11){
            ...
            if(solution==1){
                var vid = document.getElementById("0.02conc");
            }
            else if(solution==2){
                var vid = document.getElementById("0.04conc");
            }
            else if(solution==3){
                var vid = document.getElementById("0.06conc");
            }
            else if(solution==4){
                var vid = document.getElementById("0.08conc");
            }
            else if(solution==5){
                var vid = document.getElementById("0.10conc");
            }
    ...
    function disposeGraph(){
        if(step_no==12){
            ...
            document.getElementById('0.02conc').style.visibility='hidden';
            document.getElementById('0.04conc').style.visibility='hidden';
            document.getElementById('0.06conc').style.visibility='hidden';
            document.getElementById('0.08conc').style.visibility='hidden';
            document.getElementById('0.10conc').style.visibility='hidden';
